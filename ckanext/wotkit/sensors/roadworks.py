...
def getSensorSchema():
    schema = [
              ...
              {"name":"endtime","type":"STRING","required":False,"longName":"Ideal Traffic time (no traffic)"},
              {"name":"starttime","type":"STRING","required":False,"longName":"Historical Traffic time"},
